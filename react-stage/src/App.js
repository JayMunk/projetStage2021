        ...
        <UserInfo>
          ...
          <div>
            <Switch>
              ...
              <Route exact path="/gestion/superviseur">
                <SuperviseurEtudiantsAssignation />
              </Route>
              <Route exact path="/gestion/allSession">
                <AllSessionInfo />
              </Route>
              <Route exact path="/rapports">
                <Rapports />
              </Route>
              <Route exact path="/rapports/offresValides">
                <PDFOffresValides />
              </Route>
              <Route exact path="/rapports/offresInvalides">
                <PDFOffresInvalides />
              </Route>
              <Route exact path="/rapports/etudiantsInscrient">
                <PDFEtudiantsInscrient />
              </Route>
              <Route exact path="/rapports/cvPendingRejected">
                <PDFCVPendingEtRejected />
              </Route>
              <Route exact path="/rapports/etudiantsSansCV">
                <PDFEtudiantsSansCV />
              </Route>
              <Route exact path="/rapports/etudiantsSansEntrevue">
                <PDFEtudiantsSansEntrevue />
              </Route>
              <Route exact path="/rapports/etudiantsAttenteEntrevue">
                <PDFEtudiantsAttenteEntrevue />
              </Route>
              <Route exact path="/rapports/etudiantsAttenteReponseEntrevue">
                <PDFEtudiantsAttenteReponseEntrevue />
              </Route>
              <Route exact path="/rapports/etudiantsTrouveStage">
                <PDFEtudiantsTrouveStage />
              </Route>
              <Route exact path="/rapports/etudiantsNoEvaluationMoniteur">
                <PDFEtudiantsNoEvaluationMoniteur />
              </Route>
              <Route
                exact
                path="/rapports/etudiantsNoEntrepriseEvalueSuperviseur"
              >
                <PDFEtudiantsNoEntrepriseEvalueSuperviseur />
              </Route>
              <Route exact path="/gestion/newContrat">
                <NewContrat />
              </Route>
              <Route exact path="/gestion/superviseur">
                <SuperviseurEtudiantsAssignation />
              ...
              <Route exact path="/evaluation/etudiant">
                <EvaluationEtudiant />
              </Route>
              <Route exact path="/evaluation/entreprise">
                <EvaluationEntreprise />
              </Route>
              <Route exact path="/gestion/demarrerContrat">
                <AfficherContrat />
              </Route>
              <Route>
                <NotFound />
