...
const SuperviseurEtudiantsAssignation = () => {
    ...
    useEffect(() => {
        if (!loggedUser.isLoggedIn || !loggedUser.role == "GESTIONNAIRE") history.push("/")
    ...
    return (
        <div className="container text-center">
            <h1>Gestion Superviseurs</h1>
            {listSuperviseurs.length == 0 ?
                <div>
                    <hr></hr>
                    <h3 className="mt-4"><strong>Aucun superviseur inscris a la session actuelle</strong></h3>
                </div>
                :
                <div>
                    <Row>
